...
<?php get_header(); ?>
  ...
  <section id="portfolio">
    <div class="container-fluid p-0">
     ...
     <!--      <a class="portfolio-box" href="<img src='<?php// echo get_template_directory_uri(); ?>'./img/portfolio/fullsize/1.jpg />"> -->

          	<a href="<?php echo get_template_directory_uri(); ?>/img/portfolio/fullsize/1.jpg"> <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>./img/portfolio/thumbnails/1.jpg" width="" height="" alt="" /> </a>
            
            <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>./img/portfolio/thumbnails/1.jpg" width="" height="" alt="" />
